...
/**
 * Класс киента REST API SendPulse от разработчиков сервиса даптипрованный для интеграции в модуль
 * @see https://github.com/sendpulse/sendpulse-rest-api-php
 * @see https://login.sendpulse.com/manual/rest-api/
...
class ApiClient
{
	...
	public function __construct($userId, $secret)
	{
		...
		$this->token = true;//$this->tokenStorage->get($hashName);
